...
## 六、外部网页材料（抓取快照，2026-09-05 起；外部材料，不构成本人语料）

> 快照在 `corpus/sources/crawled/`（INBOX.md 为只追加台账）。本表内容被 `profile/` 引用前须经本人过目；否则仅作外部参考。

| ID | 来源 | 位置 | 提供了什么 | 用途状态 |
| --- | --- | --- | --- | --- |
| W1 | trq212（Thariq，Claude Code 团队）X 长文《Using Claude Code: The Unreasonable Effectiveness of HTML》（2026-05-08，浏览 14.6M） | `corpus/sources/crawled/2026-09-05-1738-x.com-trq212-status-2052809885763747935.md` | HTML 输出四理由（密度/可读/可分享/双向交互）+ 20 示例 + 「git 内内容仍 Markdown 为 source of truth」的自我限定 | `references/practical/HTML输出协议.md` 的核心依据（本人 2026-09-05 指令采纳） |
| W2 | 0x_XiaoBaiAI（"bai · 小白"，ETH-CHINA，DevRel @ETHPanda）帖（2026-09-03）："我觉得这个视频已经达到可以进军知识讲解赛道的条件了😃" + 46.1s/1920×1080 横版视频 | `corpus/sources/crawled/2026-09-05-1738-x.com-0x_XiaoBaiAI-status-2095379494865670531.md` | 「知识讲解短视频怎么做」素材：视频规格与数据 ✅；博主具体制作工具【待确认】（无公开工作流材料，沙盒无法播放视频） | `outbox/知识短视频完整流程.html`（一次性交付物，不进 git）素材 |
